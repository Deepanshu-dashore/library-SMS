...
export default function ViewPaymentPage() {
  ...
  if (!payment)
    return (
      <div className={clsx(
        "p-10 text-center font-black rounded-2xl mx-10 mt-10 border",
        mode === "dark"
    ...
    <div className="selection:bg-gray-100 selection:text-gray-900">
      <div className="max-w-6xl">
          ...
          actionNode={
            <div className="flex gap-2">
              <Button
                ...
                className={clsx(
                  "px-6 py-2.5 font-medium flex items-center gap-2 border",
                  mode === "dark"
                    ? "border-emerald-950 bg-transparent text-emerald-400 hover:bg-emerald-950/20"
              ...
              <Button
                ...
                className={clsx(
                  "px-6 py-2.5 font-medium flex items-center gap-2 text-white",
        ...
        <div className="mt-10 flex flex-col items-center">
          <div className={clsx(
            "scale-75 origin-top border rounded-sm overflow-hidden",
            mode === "dark" ? "border-gray-800 shadow-none" : "border-gray-100"
          )}>
